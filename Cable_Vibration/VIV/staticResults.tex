%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Results of Static-Cylinder Simulations}
...
yaw angles, $\beta=0,15,30,\,\&\,45$ degrees. The component of the freestream
velocity normal to the cylinder axis is used as the reference velocity scale to
define a new set of non-dimensional quantities, such as Reynolds number,
$Re_{D,n} = \rho V_n D / \mu$, Strouhal number, $St_{p,n}=f\,D /V_n$, and
aerodynamic pressure coefficient, $\overline{C}_{p,n}=2
