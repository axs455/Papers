...
set output 'spectra_RV5p9.eps'
set arrow 1 from .1695,0 to 0.1695,0.3 ls 11 nohead
set label 1 "$k_N$" at 0.125,0.25
...
set key left top
set output 'spectra_RV5p9_log.eps'
set logscale x
set format y "10^{%+3T}"
set logscale y
set xrange[0.01:1]
...
!${HOME}/bin/latexit.pl spectra_RV5p9
!${HOME}/bin/latexit.pl spectra_RV5p9_log
!rm -f *.eps *.tex junk.*
