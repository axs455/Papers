...
set output 'spectra_RV3.eps'
set arrow 1 from .333,0 to 0.333,0.5 ls 11 nohead
set label 1 "$k_N$" at 0.34,0.2
...
set key left top
set output 'spectra_RV3_log.eps'
set logscale x
set format y "10^{%+3T}"
set logscale y
set xrange[0.01:1]
...
!${HOME}/bin/latexit.pl spectra_RV3
!${HOME}/bin/latexit.pl spectra_RV3_log
!rm -f *.eps *.tex junk.*
